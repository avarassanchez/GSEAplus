      ...
      tabItem(tabName = "dashboard",
              tabsetPanel(
                ...
                tabPanel(title = strong("SIGNIFICANCE"), icon = icon("sync"),
                         column(width = 4, verticalLayout(box(plotOutput("panel1_copy"), 
                                                              div(downloadButton(outputId = "sig_plot", label = "GSEA plot", icon = icon("download"), style = "color: black; margin-left: 15px; margin-bottom: 5px;"),
                                                                  downloadButton(outputId = "sig_null", label = "Null distribution", icon = icon("download"), style = "color: black; margin-left: 15px; margin-bottom: 5px;")),
                                                              width = 300),
                                                          box(uiOutput("null_dist"), 
                                                              width = 300))),
                         column(width = 8, verticalLayout(box(tableOutput("summary_copy"),
                                                              tableOutput("statistics"),
                                                              div(downloadButton(outputId = "sig_table", label = "", icon = icon("download"), style = "color: black; margin-left: 15px; margin-bottom: 5px;")),
                                                              width = 500)))))),
      tabItem(tabName = "loading_data",
              tabsetPanel(tabPanel(strong("SELECTION"), icon = icon("list"),
                                   box(h2("Loading files:"),
                                       ...
                                       radioButtons("header", label = "Header included", choices = list("Yes" = 1, "No" = 2), selected = 2)),
